...
public class typeof_AttributeReference_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode attributeReference, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      ...
      EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:8337cabc-d565-4711-bff9-f7d3ea2e7b7c(net.dwarfguide.creature.typesystem)", "8701932881020807702", 0, null);
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:8337cabc-d565-4711-bff9-f7d3ea2e7b7c(net.dwarfguide.creature.typesystem)", "8701932881020807699", true), (SNode) new typeof_AttributeReference_InferenceRule.QuotationClass_sxda2h_a0a0a0().createNode(typeCheckingContext), _info_12389875345);
    }
  }
  ...
  public static class QuotationClass_sxda2h_a0a0a0 {
    public QuotationClass_sxda2h_a0a0a0() {
    }
