...
public class Attribute extends BaseConcept implements Feature, Entity {
  public static final String concept = "net.dwarfguide.creature.structure.Attribute";
  ...
  public int getIdentifier() {
    return this.getIntegerProperty(Attribute.IDENTIFIER);
  }

  public void setIdentifier(int value) {
    this.setIntegerProperty(Attribute.IDENTIFIER, value);
  }
  ...
  public static Attribute newInstance(SModel sm, boolean init) {
    return (Attribute) SModelUtil_new.instantiateConceptDeclaration("net.dwarfguide.creature.structure.Attribute", sm, GlobalScope.getInstance(), init).getAdapter();
  }
